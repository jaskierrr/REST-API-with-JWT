...
type PostUsersIDTaskCompleteHandlerFunc func(PostUsersIDTaskCompleteParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostUsersIDTaskCompleteHandlerFunc) Handle(params PostUsersIDTaskCompleteParams, principal interface{}) middleware.Responder {
...
type PostUsersIDTaskCompleteHandler interface {
	Handle(PostUsersIDTaskCompleteParams, interface{}) middleware.Responder
}
